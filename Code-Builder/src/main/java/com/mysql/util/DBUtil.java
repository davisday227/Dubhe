...
public class DBUtil {
    ...
    private static Connection produceConnection() throws Exception {
        ...
        String url = String.format("jdbc:mysql://%s:%s/%s?characterEncoding=%s&useSSL=false&allowPublicKeyRetrieval=true", config.getIp(), config.getPort(), config.getDataBase(), config.getEncoding());
